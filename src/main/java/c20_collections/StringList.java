...
/*
    c20_collections 패키지생성
    StringList.java 생성

    1. JAVA Collection Framework란?
        자바에서 데이터를 효율적으로 저장하고 관리하기 위한 자료구조와 알고리즘을 제공하는
        라이브러리
        컬렉션 프레임워크를 사용하면 다양한 자료구조를 쉽게 구현하고, 데이터를 추가, 삭제, 정렬, 검색 등의 작업을 간편하게 수행 가능
    ...
    3. Java Collection 구조
        컬렉션 프레임워크는 크게 세가지 주요 '인터페이스'를 중심으로 구성됨
        1) List
...
public class StringList {
    public static void main(String[] args) {
       ...
       // System.out.print("검색할 요소를 입력하세요 >>> ");
        ...
        // py 문자열이 삭제돼서 thon만 남는다거나 하는일은 없음
        ...
        // List의 요소 하나씩 뽑는 반복문      -> 향상된 for문을 사용
        for(String element : strList){
            System.out.println(element);
        }
        System.out.println("----------------------");
        // 그렇다면 일반 for문을 썼을 때는?     -> 배열의 경우 .length지만
        // List의 경우 .size()를 씁니다.
