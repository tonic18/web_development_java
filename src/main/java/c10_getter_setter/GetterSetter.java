...
/*
    1. Setter / Getter의 필요성
        문제상황
        클래스를 만든다고 가정. 예를들어, 사람(Person) 클래스를 만들면서
        ...
        2. Setter / Getter란?
            ...
            Getter
                ...
                Person.java / PersonMain.java 를 확인할 것 -> 응용 코드 작성

                수업 내용 확인을 위해 파일 내부를 검색하려면 -> ctrl + f
                여태까지 수업한 전체 패키지 및 파일 확인에서 내용 확인 하려면
                -> ctrl + shift + f
                ...
                "이를 통해 유효성을 검증하거나 특정한 로직을 추가"할 수 있습니다.
